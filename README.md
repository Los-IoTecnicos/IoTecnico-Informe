...
| US014      | Detalles de los Planes de Servicio | Tasks-02 | Crear la sección de comparación de planes                                                                             | Crear una sección que permita a los usuarios comparar distintos planes de manera clara y sencilla.                                      | 6 Hours           | Victor Yordi     | Done                                           |
...
| US007      | Registro de Inventario             | Tasks-04 | Desarrollar una página o panel                                                                                                      |Desarrollar una página o panel que sirva como interfaz central para el usuario, donde se puedan visualizar y gestionar las funcionalidades del sistema de manera intuitiva y accesible.           | 6 Hours           | Juan Jose Chacon | Done                                           |
...
| US012      | Interfaz Intuitiva                 | Tasks-06 | Desarrollar una vista simple para mostrar el estado actual                                                                     | Desarrollar una vista simple que muestre el estado actual del sistema, proporcionando a los usuarios una visualización clara y concisa de la información relevante y el rendimiento en tiempo real.           | 6 Hours           | Ismael Zamora    | Done                                           |
|            |                                    |          |                                                                                                                                |             |                   |                  |                                                |
